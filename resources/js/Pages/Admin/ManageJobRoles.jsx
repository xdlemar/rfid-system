...
export default function ManageJobRoles({ auth, jobRoles }) {
    ...
    const handleSubmit = (e) => {
        ...
        const successHandler = () => {
            closeModal();
            alert(editingJobRole ? 'Job role updated successfully!' : 'Job role added successfully!');
        };
    ...
    const handleDelete = (id) => {
        if (window.confirm('Are you sure you want to delete this job role?')) {
            destroy(route('jobroles.destroy', id), {
                onSuccess: () => alert('Job role deleted successfully!'),
            });
        }
    };
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Manage Job Roles</h2>}
        >
